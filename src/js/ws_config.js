...
config.appGitRepo = 'https://github.com/SpookyPool/elphyre-wallet-electron';
...
config.blockExplorerUrl = 'http://elph.spookypool.nl/Explorer/?hash=[[TX_HASH]]#blockchain_transaction';

// default remote node to connect to, set this to a known reliable node for 'just works' user experience
config.remoteNodeDefaultHost = 'spookypool.nl';

// remote node list update url, set to null if you don't have one
config.remoteNodeListUpdateUrl = 'https://raw.githubusercontent.com/spookypool/elphyrecoin-nodes-json/master/elphyrecoin-nodes.json';
